SUMMARY = "Touch Interaction example: ExperimentalGestures"
DESCRIPTION = "GestureArea QML Element example"
...
FILES_${PN} += "${examples_prefix}/declarative/touchinteraction/gestures/${PN}/*"
FILES_${PN}-dbg += "${examples_prefix}/declarative/touchinteraction/gestures/${PN}/.debug/*"
FILES_${PN}-dev += "${examples_prefix}/declarative/touchinteraction/gestures/${PN}/*.pro"
FILES_${PN}-dev += "${examples_prefix}/declarative/touchinteraction/gestures/${PN}/*.qmlproject"
FILES_${PN}-dev += "${examples_prefix}/declarative/touchinteraction/gestures/${PN}/*.cpp"
